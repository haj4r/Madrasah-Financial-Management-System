                ...
                <div class="container">
                    <div class="custom-border p-3 ">
                        <div class="is-flex is-justify-content-space-between is-align-items-center ">
                            <div>
                                <h2 class="has-text-weight-bold is-size-3">Donation Ledger</h2>
                        ...
                        <div class="table-container">
                            <table class="table is-striped is-fullwidth">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($mysqli, "SELECT * FROM donation");
                                    ...
                                    $sumResult = mysqli_query($mysqli, "SELECT SUM(amount) AS total_amount FROM donation");
