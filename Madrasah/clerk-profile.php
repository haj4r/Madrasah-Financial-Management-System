...
<body data-theme="light">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input class="input custom-input2" type="text"
                                                    placeholder="Phone Number" id="phonenum" name="phonenum">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="columns">
                                    ...
                                    <div class="column is-one-third">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input class="input custom-input2" name="newPassword" type="password"
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.error) {
                        ...
                        $('#name').val(data.clerk_name);
                        console.log(data.clerk_email);
                        $('#phonenum').val(data.clerk_phonenum);
                        $('#email').val(data.clerk_email);
                    }
                },
        ...
        $(document).on('submit', '#ajaxUpdateProfile', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("submit_ajaxUpdateProfile", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (res.status == 100) {
                        ...
                        showNotification("Profile Updated Failed");
                    }
                }
            });
        });

        $(document).on('submit', '#ajaxChangePassword', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("submit_ajaxChangePassword", true);
