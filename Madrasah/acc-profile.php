...
<body data-theme="light">
    ...
    <div class="content-wrapper">
        ...
        <div class="main-content">
            <section class="section">
                <div class="container">
                    <h1 class="title has-text-grey"><?php echo ucfirst($_SESSION['username']) ?> (<?php echo $_SESSION['category'] ?>)</h1>
                    <div class="column is-one-two">
                        <figure class="image is-128x128" style="border-radius: 50%; border-color: #000;">
                            <img id="profile-img" src="assets/user.png" alt=""
                        ...
                        <div class="file is-small">
                            <label class="file-label">
                                ...
                                <span class="button is-custom file-label has-text-weight-semibold">Upload
                                    picture</span>
                            </label>
                        </div>
                    </div>
                    <div class="column">
                        ...
                        <div id="details-tab" class="tab-content">
                            <form id="ajaxInsertProfile">
                                <div class="columns">
                                    <div class="column is-one-third">
                                        <div class="field">
                                            <input type="hidden" name="acc_login_id" id="acc_login_id"
                                                value="<?php echo $_SESSION['login_id'] ?>" />
                                            <label class="label has-text-grey">Name</label>
                                            <div class="control">
                                                <input class="input custom-input2" type="text" name="acc_name"
                                                    id="acc_name">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input class="input custom-input2" type="text"
                                                    placeholder="Phone Number" name="acc_phonenum" id="acc_phonenum">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="columns">
                                    <div class="column is-one-third">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input class="input custom-input2" type="text"
                                                    placeholder="Email Address" name="acc_email" id="acc_email">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="column is-one-third">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                <input class="input custom-input2" type="text"
                                                    placeholder="Email Address" name="acc_address" id="acc_address">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            var acc_login_id = $('#acc_login_id').val();
            console.log(acc_login_id);
            $.ajax({
                type: "POST",
                url: "code.php",
                data: {
                    'acc_login_id': acc_login_id
                },
                dataType: 'JSON',
                success: function (response) {
                    if (response.error) {
                        ...
                        console.log("name: " + data.acc_name);
                        $('#acc_phonenum').val(data.acc_phonenum);
                        $('#acc_email').val(data.acc_email);
                        $('#acc_address').val(data.acc_address);
                    }
                },
        ...
        $(document).on('submit', '#ajaxInsertProfile', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("submit_ajaxInsertProfile", true);
        ...
        $(document).on('submit', '#ajaxAccountPassword', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("submit_ajaxAccountPassword", true);
